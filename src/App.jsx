...
export default function App() {
  ...
  const categories = useMemo(() => [...new Set(photos.map((p) => p.category))].sort(), []);
      ...
      <main className="max-w-7xl mx-auto px-6 pb-16">
        {filtered.length === 0 ? (
          <div className="text-center py-32">
            ...
            <p className="font-display text-2xl text-white/40">No photos found</p>
          ...
          <div className={
            ...
            {filtered.map((photo) => (
              <div key={photo.id} className={view === "masonry" ? "break-inside-avoid mb-4" : ""}>
